...
TOKEN = "BBFF-NVAeQMMWfe62gsKjThSOndm5WpGSc5"  # Put your TOKEN here
DEVICE_LABEL = "gwd"  # Put your device label here 
VARIABLE_LABEL_1 = "accelerometer"  # Put your first variable label here 
VARIABLE_LABEL_2 = "vibration"
VARIABLE_LABEL_3 = "temperature"
VARIABLE_LABEL_4 = "ultrasonik"
GPIO_TRIGGER = 2
GPIO_ECHO = 3
...
#     value_1 = mpu.get_accel_data()['y']
    value_1 = 0
    value_2 = vibration
    value_3 = temp()
    value_4 = distance()
    # value_2 = mpu.get_gyro_dummy()['y']
